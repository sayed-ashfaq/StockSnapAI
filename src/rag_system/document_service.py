...
from exceptions.custom_exception import FileProcessingError
...
class DocumentService:
    ...
    def _process_pdf(self, file_path: str) -> Tuple[List[Document], Dict[str, Any]]:
